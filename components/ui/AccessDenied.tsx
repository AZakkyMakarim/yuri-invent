...
export default function AccessDenied() {
    return (
        <div className="flex flex-col items-center justify-center h-[60vh] text-center p-6 animate-fadeIn">
            <div className="w-16 h-16 rounded-full bg-(--color-danger)/10 flex items-center justify-center mb-6">
                <ShieldAlert size={32} className="text-(--color-danger)" />
            </div>
            ...
            <Link
                href="/dashboard"
                className="px-6 py-2.5 bg-(--color-primary) text-white rounded-lg hover:bg-(--color-primary)/90 transition-colors font-medium shadow-sm hover:shadow-md"
            >
                Back to Dashboard
            </Link>
        </div>
